...
import socket,pygame,cPickle,select,time
...
class Game(object):
	...
	def Draw(self,scr,i,pos):
		i += 1
		obr = 'C:/Python27/img/gr' + str(i) + '.png'
	...
	def initGame(self,data):
		...
		self.warstwa = pygame.image.load('C:/Python27/img/plik.jpg').convert_alpha()
		self.b = pygame.image.load('C:/Python27/img/mina.png').convert_alpha()
